...
- Compute price based on different criteria: Other pricelist, Cost price, List price, Vendor price
...
- `web.report_assets_common`: `product/static/src/scss/report_label_sheet.scss`
- `web.assets_unit_tests`: `product/static/tests/**/*`
